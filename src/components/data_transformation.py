...
from sklearn.preprocessing import Pipeline,OneHotEncoder,StandardScaler
from dataclasses import dataclass

@dataclass
class DataTransformationConfig:
    Preprocesor_obj_file_path =os.path.join('artificats',"processor.pkl")
...
class DataTransformation:
    ...
    def  get_data_transformer_object(self):
         ...
         try:
              ...
              logging.info(f"Categorical Columns standard scaling completed :{categorical_columns}")
